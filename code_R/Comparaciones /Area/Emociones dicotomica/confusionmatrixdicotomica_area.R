...
predTecnologico<- factor(modatecnologico, levels = c(0,1))
...
predSocial <- factor(modasocial, levels = c(0,1))
...
precision_Tec<-c(Precision(IA$IA, predTecnologico, positive=0),Precision(IA$IA, predTecnologico, positive=1))
recall_Tec <-c(Recall(IA$IA, predTecnologico, positive=0), Recall(IA$IA, predTecnologico, positive=1))
f1_score_vector_Tec<- c(F1_Score(IA$IA, predTecnologico, positive=0),F1_Score(IA$IA, predTecnologico, positive=1))

metrica_Tec_dico <-data.frame(Columna1=precision_Tec, Columna2=recall_Tec, Columna3=f1_score_vector_Tec)
colnames(metrica_Tec_dico) <- c("Precisión","Recall","F1_Score") 

# Calcular métricas Social.

precision_Soc<-c(Precision(IA$IA, predSocial, positive=0),Precision(IA$IA, predSocial, positive=1))
recall_Soc <-c(Recall(IA$IA, predSocial, positive=0), Recall(IA$IA, predSocial, positive=1))
f1_score_vector_Soc<- c(F1_Score(IA$IA, predSocial, positive=0),F1_Score(IA$IA, predSocial, positive=1))

metrica_Soc_dico <-data.frame(Columna1=precision_Soc, Columna2=recall_Soc, Columna3=f1_score_vector_Soc)
colnames(metrica_Soc_dico) <- c("Precisión","Recall","F1_Score") 
...
View(metrica_Tec_dico)
View(metrica_Soc_dico)
